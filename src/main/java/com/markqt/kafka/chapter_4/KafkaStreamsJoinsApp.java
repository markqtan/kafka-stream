...
package com.markqt.kafka.chapter_4;
...
import com.markqt.kafka.chapter_4.joiner.PurchaseJoiner;
import com.markqt.kafka.chapter_4.timestamp_extractor.TransactionTimestampExtractor;
import com.markqt.kafka.clients.producer.MockDataProducer;
import com.markqt.kafka.model.CorrelatedPurchase;
...
public class KafkaStreamsJoinsApp {
    ...
    public static void main(String[] args) throws Exception {
        ...
        JoinWindows twentyMinuteWindow =  JoinWindows.of(Duration.ofMinutes(20));//60 * 1000 * 20);
