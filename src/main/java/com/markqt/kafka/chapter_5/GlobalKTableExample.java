package com.markqt.kafka.chapter_5;


import static com.markqt.kafka.clients.producer.MockDataProducer.STOCK_TRANSACTIONS_TOPIC;
import static com.markqt.kafka.util.Topics.CLIENTS;
import static com.markqt.kafka.util.Topics.COMPANIES;
...
import com.markqt.kafka.chapter_5.timestamp_extractor.StockTransactionTimestampExtractor;
import com.markqt.kafka.clients.producer.MockDataProducer;
import com.markqt.kafka.model.StockTransaction;
import com.markqt.kafka.model.TransactionSummary;
import com.markqt.kafka.util.datagen.CustomDateGenerator;
import com.markqt.kafka.util.datagen.DataGenerator;
import com.markqt.kafka.util.serde.StreamsSerdes;
